...
These JSON files are machine-readable outputs from the local verification performed in September 2026. The maintained interpretation, environment, measurement boundaries, and limitations are in the [verification record](../verification.md).

| Artifact | Meaning |
|---|---|
| [`2026-09-09-http.json`](2026-09-09-http.json) | Clean ten-minute HTTP/SSE baseline, pre-optimization build |
...
| [`2026-09-20-http.json`](2026-09-20-http.json) | Ten-minute HTTP/SSE run on the four-phase build, second of two agreeing runs |
| [`2026-09-20-http-repeat.json`](2026-09-20-http-repeat.json) | First 20 September run; agrees within six percent, retained to document repeatability |
